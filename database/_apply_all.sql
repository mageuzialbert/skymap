-- =====================================================================
-- Skymap - consolidated schema (run order from scripts/migrate.js)
-- Paste this WHOLE file into the NEW project: Dashboard -> SQL Editor -> Run.
-- Safe to re-run. A few CREATE POLICY/TRIGGER lines lack IF NOT EXISTS, so on a
-- re-run they error with already-exists - harmless, ignore them.
-- =====================================================================
